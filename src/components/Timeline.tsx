      ...
      <div className="items-container">
        ...
        <VerticalTimeline>
          ...
          >
            ...
            <p>
            Built user-friendly frontends, contributed to backend features with AI tools, and collaborated in an agile startup environment to drive innovation.
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
          ...
          <VerticalTimelineElement
            ...
            icon={<FontAwesomeIcon icon={faBriefcase} />}
          >
            <h3 className="vertical-timeline-element-title">Administrative Assistance</h3>
            <h4 className="vertical-timeline-element-subtitle">Albany, NY</h4>
            <p>
              Customer Relationship Management (CRM), Problem Solving, Orgnization Skills, Communication.
            </p>
          </VerticalTimelineElement>
          {/* <VerticalTimelineElement
            className="vertical-timeline-element--work"
